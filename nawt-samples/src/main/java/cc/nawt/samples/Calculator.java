...
public final class Calculator {
    ...
    public static void main(String[] args) {
        Toolkit.launch("NAWTCalc", Calculator::buildUi);
    }
    ...
    private static void showAbout() {
        MessageDialog.builder()
            ...
            .title("About NAWTCalc")
            .message("NAWTCalc")
            .details("A four-function calculator demonstrating NAWT's Grid layout. "
                + "Built with the NAWT toolkit (https://github.com/BryanSant/nawt).")
            .buttons("OK")
            .show();
    }
