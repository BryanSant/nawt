...
final class Delegates {
    ...
    static final MemorySegment BUTTON_ACTION_SEL = Objc.sel("swatClick:");
    ...
    static final MemorySegment TOGGLE_ACTION_SEL = Objc.sel("swatToggle:");
     ...
     * Resolver returns the {@link io.github.swat.spi.TreeNodeData} for a path
     * string, or null if the path is invalid. */

    static final MemorySegment OUTLINE_DATASOURCE_CLASS;
    static final ConcurrentHashMap<Long, java.util.function.Function<String, io.github.swat.spi.TreeNodeData>>
     ...
     * "swat.start.<n>" / "swat.end.<n>". Flexible space between the regions
    ...
    private static MemorySegment registerButtonTargetClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatButtonTarget");
        try {
    ...
    private static MemorySegment registerWindowDelegateClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatWindowDelegate");
        try {
    ...
    private static MemorySegment registerTextFieldDelegateClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatTextFieldDelegate");
        try {
            MethodHandle mh = MethodHandles.lookup().findStatic(
    ...
    private static MemorySegment registerMenuTargetClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatMenuActionTarget");
        try {
            MethodHandle mh = MethodHandles.lookup().findStatic(
    ...
    private static MemorySegment registerTableDataSourceClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatTableDataSource");
        try {
    ...
    private static MemorySegment registerToggleTargetClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatToggleTarget");
        try {
            MethodHandle mh = MethodHandles.lookup().findStatic(
    ...
    private static MemorySegment registerTabsDelegateClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatTabsDelegate");
        try {
    ...
    private static MemorySegment registerCanvasViewClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSView"), "SwatCanvasView");
        try {
    ...
    private static MemorySegment registerOutlineDataSourceClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatOutlineDataSource");
        try {
    ...
    private static io.github.swat.spi.TreeNodeData resolveOutlineNode(
    ...
    private static long outlineNumberOfChildren(
        ...
        try {
            ...
            io.github.swat.spi.TreeNodeData node = resolveOutlineNode(self, item);
    ...
    static final String TOOLBAR_START_PREFIX = "swat.start.";
    static final String TOOLBAR_END_PREFIX = "swat.end.";

    private static MemorySegment registerToolbarDelegateClass() {
        MemorySegment cls = Objc.allocateClassPair(Objc.cls("NSObject"), "SwatToolbarDelegate");
        try {
